...
class HomeAssistantRisk(str,Enum): READ_ONLY="read_only"; CONFIRM_REQUIRED="confirm_required"; HIGH_IMPACT_CONFIRM_REQUIRED="high_impact_confirm_required"; FORBIDDEN="forbidden"
