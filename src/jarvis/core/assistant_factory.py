...
def create_read_only_assistant(openai_provider, home_assistant_client, allowed_entity_ids=frozenset()):
 return AssistantOrchestrator(OpenAIAssistantProposalProvider(openai_provider),HomeAssistantReadAdapter(home_assistant_client),frozenset(allowed_entity_ids))
