...
class BlueprintPlannerTests(unittest.TestCase):
    ...
    def test_generated_blueprint_has_ui_selectors_and_dynamic_data_actions(self):
        ...
        self.assertEqual(pending.count("action: tts.speak"), 4)
        self.assertEqual(pending.count('delay: "00:00:01"'), 2)
        self.assertEqual(pending.count("cache: true"), 4)
        self.assertEqual(pending.count("preferred_format: mp3"), 4)
        self.assertEqual(pending.count("preferred_sample_rate: 44100"), 4)
        self.assertEqual(pending.count("preferred_sample_channels: 2"), 4)
