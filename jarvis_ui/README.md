...
4. In Home Assistant, open **Settings -> Dashboards**, open the three-dot menu,
   and select **Resources**. Add `/local/jarvis/jarvis-ui.js?v=0.23.2`
...
the old resource with `/local/jarvis/jarvis-ui.js?v=0.23.2`, restart Home
