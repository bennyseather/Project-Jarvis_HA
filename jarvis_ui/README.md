...
4. In Home Assistant, open **Settings -> Dashboards**, open the three-dot menu,
   and select **Resources**. Add `/local/jarvis/jarvis-ui.js?v=0.28.1`
...
the old resource with `/local/jarvis/jarvis-ui.js?v=0.28.1`, restart Home
