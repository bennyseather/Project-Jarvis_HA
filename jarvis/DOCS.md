...
Version 0.13.0 includes the optional complete Jarvis Dashboard System. Download the
...
`/local/jarvis/jarvis-ui.js?v=0.13.0` as a JavaScript module in Home Assistant
