...
Version 0.12.3 includes the optional complete Jarvis Dashboard System. Download the
...
`/local/jarvis/jarvis-ui.js?v=0.12.3` as a JavaScript module in Home Assistant
