...
Version 0.26.3 includes the optional complete Jarvis Dashboard System. Download the
...
`/local/jarvis/jarvis-ui.js?v=0.26.3` as a JavaScript module in Home Assistant
