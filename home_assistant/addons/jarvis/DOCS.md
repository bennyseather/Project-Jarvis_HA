...
Version 0.25.1 includes the optional complete Jarvis Dashboard System. Download the
...
`/local/jarvis/jarvis-ui.js?v=0.25.1` as a JavaScript module in Home Assistant
