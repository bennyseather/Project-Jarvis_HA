    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}button,input,select{font:inherit}.screen{height:100%;padding:14px;display:grid;grid-template-columns:3fr 1fr;gap:12px;background:radial-gradient(circle at 34% 42%,rgba(0,139,214,.22),transparent 38%),linear-gradient(145deg,#020811,#061a2d)}
        ...
        .overlay{position:fixed;inset:0;background:rgba(0,5,10,.9);display:grid;place-items:center;z-index:4}.dialog{position:relative;width:min(720px,94vw);height:min(450px,95vh);padding:8px 8px 54px;border:1px solid #20d8ff;background:#041523;box-shadow:0 0 55px rgba(32,216,255,.25);overflow:hidden}.dialog h2{margin:0 0 4px;font:800 13px monospace;color:#20d8ff;text-transform:uppercase}.touch-grid{display:grid;grid-template-columns:1.4fr 1fr;gap:5px;height:calc(100% - 17px)}.touch-panel{padding:5px;border:1px solid rgba(32,216,255,.25)}.touch-panel.days-panel,.touch-panel.after-panel{grid-column:1/-1}.touch-label{font:700 7px monospace;letter-spacing:.14em;color:#9dd8e8;text-transform:uppercase}.stepper{display:grid;grid-template-columns:40px 1fr 40px;align-items:center;gap:4px;margin-top:2px}.stepper strong{font:800 23px monospace;text-align:center;color:#e7fbff}.touch-btn{min-height:31px;border:1px solid #20d8ff;color:#e7fbff;background:#071d2c;font-weight:900;font-size:16px}.choice{display:grid;grid-template-columns:1fr 1fr;gap:4px;margin-top:2px}.choice button,.days button,.after-choice button{min-height:28px;border:1px solid rgba(32,216,255,.45);color:#9dd8e8;background:#07131f;font:800 8px monospace;text-transform:uppercase}.choice button.active,.days button.active,.after-choice button.active{background:#20d8ff;color:#00131a}.days{display:grid;grid-template-columns:repeat(9,1fr);gap:3px;margin-top:3px}.after-choice{display:grid;grid-template-columns:repeat(3,1fr);gap:4px;margin-top:3px}.buttons{position:absolute;left:8px;right:8px;bottom:7px;display:flex;gap:8px;justify-content:flex-end}.buttons button,.alarm-actions button{min-height:36px;padding:0 16px;border:1px solid #20d8ff;color:#dffcff;background:#071d2c;font-weight:800;text-transform:uppercase}.buttons .primary{background:#20d8ff;color:#00131a}.alarm-dialog{text-align:center;height:auto;padding-bottom:18px}.alarm-dialog .wake{font:800 clamp(36px,8vw,72px) monospace;color:#20d8ff}.alarm-actions{display:flex;gap:14px;justify-content:center;margin-top:24px}
